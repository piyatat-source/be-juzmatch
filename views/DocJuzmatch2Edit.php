...
// Page object
$DocJuzmatch2Edit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { doc_juzmatch2: currentTable } });
var currentForm, currentPageID;
var fdoc_juzmatch2edit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fdoc_juzmatch2edit = new ew.Form("fdoc_juzmatch2edit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fdoc_juzmatch2edit;

    // Add fields
    var fields = currentTable.fields;
    fdoc_juzmatch2edit.addFields([
    ...
    // Form_CustomValidate
    fdoc_juzmatch2edit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdoc_juzmatch2edit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fdoc_juzmatch2edit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fdoc_juzmatch2edit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fdoc_juzmatch2edit" id="fdoc_juzmatch2edit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fdoc_juzmatch2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch2edit", "x_loan_contact_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch2edit", "x_contract_expired", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch2edit", "x_first_benefits_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoc_juzmatch2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoc_juzmatch2edit", "x_management_agent_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_doc_juzmatch2_status">
    <select
        ...
        data-select2-id="fdoc_juzmatch2edit_x_status"
...
<script>
loadjs.ready("fdoc_juzmatch2edit", function() {
    var options = { name: "x_status", selectId: "fdoc_juzmatch2edit_x_status" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdoc_juzmatch2edit.lists.status.lookupOptions.length) {
        options.data = { id: "x_status", form: "fdoc_juzmatch2edit" };
    } else {
        options.ajax = { id: "x_status", form: "fdoc_juzmatch2edit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php } ?>
    ...
    <input type="hidden" data-table="doc_juzmatch2" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
